...
import { addStudentRequest,addStudentSuccess,addStudentFailure } from '../redux/actions/student.action';
import { createStudent } from '../services/student.service';


const AddStudentComponents = (props) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    props.addStudentRequest();
    createStudent(student).then((response)=>{
      props.addStudentSuccess(response?.data);
      navigate("/");
    }).catch((error) => {
      props.addStudentFailure(error);
    })
  }
...
const mapDispatchToProps = (dispatch) => {
  return {
    addStudentRequest:()=> dispatch(addStudentRequest()),
    addStudentSuccess:(student)=> dispatch(addStudentSuccess(student)),
    addStudentFailure:(error)=> dispatch(addStudentFailure(error))
  }
}

export default connect(null, mapDispatchToProps)(AddStudentComponents);
